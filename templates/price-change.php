 ...
 * @var int $time_limit
 * @var string $cog_meta_key
 * @var array $custom_expression_placeholders
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-4 pe-0 wh-nav-pills">
                <div class="wh-settings-sidebar">
                    <div class="wh-logo">
                        <img src="<?php echo esc_url(WEBHEAD_BULK_PRICE_UPDATE_PLUGIN_URL . 'assets/img/webhead_logo.svg?v=2'); ?>"
                    ...
                    <div class="wh-settings-tab d-flex align-items-start">
                        <div class="nav flex-column nav-pills w-100" id="v-pills-tab" role="tablist"
                            ...
                            <button class="nav-link" id="v-pills-price-rules-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-price-rules" type="button" role="tab"
                                aria-controls="v-pills-price-rules" aria-selected="false">
                                <span class="wh-nav-active-icon"></span>
                                <span class="d-flex flex-column align-items-start">
                                    <span class="wh-nav-title">
                                    ...
                                    <span class="wh-nav-subtitle">
                                        <?php esc_html_e('Automated price adjustments', 'wh-bulk-price-update-for-woocommerce'); ?>
                                    </span>
                                </span>
                                <span class="wh-nav-icon">
            ...
            <div class="col-lg-9 col-sm-8 ps-0 wh-nav-contents">
                <div class="card w-100">
                    <div class="card-body tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-update-price" role="tabpanel"
                            ...
                            <div class="input-group wh-price-input-group mb-3">
                                <select class="form-select" name="action_type" id="action_type"
                                    ...
                                    <option value="custom">
                                        <?php esc_html_e('Custom formula', 'wh-bulk-price-update-for-woocommerce'); ?>
                                    </option>
                                </select>

                                <input type="number" class="form-control" min="0" step="any" inputmode="decimal" id="price_value" name="price_value"
                            ...
                            <div class="wh-custom-expression-help d-none" id="wh-custom-expression-help">
                                <div class="form-text mb-2">
                                    <?php esc_html_e('Tip: build a formula with placeholders and math operators (+, -, *, /).', 'wh-bulk-price-update-for-woocommerce'); ?>
                                </div>
                                <div class="wh-custom-placeholder-list" id="wh-custom-placeholder-list">
                                    <?php foreach ((array)$custom_expression_placeholders as $placeholder_token => $placeholder_data): ?>
                                        <?php
                                        $placeholder_description = isset($placeholder_data['description']) ? (string)$placeholder_data['description'] : '';
                                        $placeholder_sample_value = isset($placeholder_data['sample_value']) ? (float)$placeholder_data['sample_value'] : 0.0;
                                        $placeholder_sample_value_text = number_format_i18n($placeholder_sample_value, wc_get_price_decimals());
                                        ?>
                                        <button type="button"
                                            class="wh-custom-placeholder-item"
                                            title="<?php echo esc_attr($placeholder_description); ?>"
                                            data-placeholder="<?php echo esc_attr('{' . $placeholder_token . '}'); ?>">
                                            <code><?php echo esc_html('{' . $placeholder_token . '}'); ?></code>
                                            <span class="wh-custom-placeholder-default">
                                                <?php
                                                printf(
                                                    /* translators: %s: default sample value for custom placeholder */
                                                    esc_html__('Default: %s', 'wh-bulk-price-update-for-woocommerce'),
                                                    esc_html($placeholder_sample_value_text)
                                                );
                                                ?>
                                            </span>
                                            <?php if ($placeholder_description !== ''): ?>
                                                <span class="wh-custom-placeholder-desc"><?php echo esc_html($placeholder_description); ?></span>
                                            <?php endif; ?>
                                        </button>
                                    <?php endforeach; ?>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-price-rules" role="tabpanel"
                            aria-labelledby="v-pills-price-rules-tab" tabindex="0">
                            <?php webhead_bulk_price_update_load_template('price-rules', [
                        ...
                        <div class="tab-pane fade" id="v-pills-settings" role="tabpanel"
                            ...
                            <form method="post" id="wh-settings-form">
                                ...
                                <div class="mb-3">
                                    <label for="cog_meta_key" class="form-label">
                                        <?php esc_html_e('Cost of goods custom field', 'wh-bulk-price-update-for-woocommerce'); ?>
                                        <span class="wh-label-help" data-bs-toggle="tooltip"
                                            data-bs-title="<?php esc_attr_e('Meta key used by Scheduled Rules > Margin Check to read Cost of Goods. Default WooCommerce key: _cogs_total_value.', 'wh-bulk-price-update-for-woocommerce'); ?>">?</span>
                                    </label>
                                    <input type="text" name="cog_meta_key" id="cog_meta_key" class="form-control"
                                        value="<?php echo esc_attr($cog_meta_key); ?>"
                                        placeholder="<?php echo esc_attr(WH_Price_Rule_Executor::get_default_cog_meta_key()); ?>">
                                    <div class="form-text">
                                        <?php esc_html_e('If you use another plugin for Cost of Goods, enter its product meta key here.', 'wh-bulk-price-update-for-woocommerce'); ?>
                                    </div>
                                </div> <!-- @.mb-3 cog_meta_key -->
                        ...
                        <div class="tab-pane fade" id="v-pills-about" role="tabpanel"
                            ...
                            <div class="mb-3">
                                <img src="<?php echo esc_url(WEBHEAD_BULK_PRICE_UPDATE_PLUGIN_URL . 'assets/img/webhead_cover.jpg?v=2'); ?>"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title fs-5 m-0" id="confirmUpdate">
